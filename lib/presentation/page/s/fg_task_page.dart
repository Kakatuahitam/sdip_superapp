...
class ForegroundTaskPageSmall extends StatefulWidget {
  const ForegroundTaskPageSmall({
    Key? key,
    // this.seconds
  }) : super(key: key);
  ...
  @override
  ForegroundTaskPageSmallState createState() => ForegroundTaskPageSmallState();
}

class ForegroundTaskPageSmallState extends State<ForegroundTaskPageSmall>{
